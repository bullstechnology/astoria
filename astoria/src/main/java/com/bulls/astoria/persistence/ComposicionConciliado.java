...
@Entity
@Table(name="composicionconciliado")

public class ComposicionConciliado implements Serializable{
	@Id
    ...
    private DetallePedidoConciliado detalle;
	...
	public DetallePedidoConciliado getDetalle() {
		return detalle;
	}
	public void setDetalle(DetallePedidoConciliado detalle) {
	...
	public String toString() {
		return "ComposicionConciliado [id=" + id + ", idproducto=" + idproducto
