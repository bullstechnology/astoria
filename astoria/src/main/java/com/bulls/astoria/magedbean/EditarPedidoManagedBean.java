...
@SessionScoped
public class EditarPedidoManagedBean extends GeneralManagedBean implements Serializable{
 ...
 //informacion bancaria
	...
	@PostConstruct
	public void EditarPedidoManagedBean(){
...
public String crearPedido(){
	...
	if (getNecesitaAuto(pedido)){
		...
		this.putAuditoria("Editar pedido", "U", "Edito pedido así : - " + pedido.toString());
		abrirNecesitaAuto();
	}else{
