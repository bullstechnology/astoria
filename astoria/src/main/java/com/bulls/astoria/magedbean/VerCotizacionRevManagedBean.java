...
@ManagedBean (name="verCotizacionRevMB")
@SessionScoped
public class VerCotizacionRevManagedBean extends GeneralManagedBean implements Serializable{
	...
	@PostConstruct
	public void VerCotizacionRevManagedBean(){
		
		borrarSession();
		bundle =  ResourceBundle.getBundle("messages");
		cotizacion = new Cotizacion();
		listaCotizaciones = new ArrayList <Cotizacion> ();
		listaCotizaciones = pedidoService.getCotizaciones("R");
	}
