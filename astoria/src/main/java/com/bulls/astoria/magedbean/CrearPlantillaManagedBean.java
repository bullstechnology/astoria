...
@SessionScoped
public class CrearPlantillaManagedBean extends GeneralManagedBean implements Serializable{
	...
	@PostConstruct
	public void CrearPlantillaManagedBean(){
...
public String onFlowProcess(FlowEvent event) {
    ...
    public String crearPedido(){
    	...
    	pedido.setComprador(null);
   		pedido.setEstado('O');//Recibido conciliado despachado cancelado o (origen - plantilla) 
    	...
    	this.putAuditoria("Crear Pedido plantilla", "C", "Creo Pedido plantilla así : - " + pedido.toString());
...
public List <Destino> getDestinos(){
    ...
    private void abrirNecesitaAuto(Integer id){
		...
		/*FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_WARN, bundle.getString("tituloalerta"), bundle.getString("alertacupo"));
		RequestContext.getCurrentInstance().showMessageInDialog(message);*/
    ...
    private void abrirConfirmacion(Integer id){
		...
		FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, bundle.getString("tituloconfirmacion"), bundle.getString("confirmacrearplantilla") + id);
		//RequestContext.getCurrentInstance().showMessageInDialog(message);
		PrimeFaces.current().dialog().showMessageDynamic(message);
