...
@SessionScoped
public class GradoManagedBean extends GeneralManagedBean implements Serializable{
...
public void CrearFlorManagedBean(){
	    ...
	    tiposGrado = dominioService.getDominios(EnuDominio.GRADOS.getIdTipoDominio());
 ...
 public void crearGrado() {
        try {
            TipoDominio tipoDominio = dominioService.getTipoDominio(EnuDominio.GRADOS.getIdTipoDominio());
            dominio = new Dominio();
        	...
        	if(this.validar()){
        		...
        		this.putAuditoria("Crear Grado", "C", "Creo el grado así : - " + dominio.toString());
        		reset();
        		tiposGrado = dominioService.getDominios(EnuDominio.GRADOS.getIdTipoDominio());
        		abrirConfirmacion();
        	}
 ...
 public void editarGrado() {
     try {
     	...
     	if(this.validarEditar()){
     		...
     		this.putAuditoria("Editar Grado", "U", "Edito el grado así : - " + dominioEditar.toString());
     		tiposGrado = dominioService.getDominios(EnuDominio.GRADOS.getIdTipoDominio());
