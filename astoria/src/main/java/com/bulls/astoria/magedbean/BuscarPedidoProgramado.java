...
@ManagedBean (name="buscarPedidoProgramadoMB")
@SessionScoped
public class BuscarPedidoProgramado extends GeneralManagedBean implements Serializable{
	...
	@PostConstruct
	public void BuscarPedidoProgramado(){
		borrarSession();
